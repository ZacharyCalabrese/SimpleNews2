...
public class News extends Fragment {
    ...
    public static void setTabTitlesHashTable(Context context){
        com.zacharycalabrese.doughboy.simplenews.activity.Data.Source news =
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.zacharycalabrese.doughboy.simplenews.activity.Data.News newsData =
                new com.zacharycalabrese.doughboy.simplenews.activity.Data.News();

        List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.News> stories =
        ...
        listView.setAdapter(new com.zacharycalabrese.doughboy.simplenews.activity.Adapter.News(
                getActivity(), stories));
    ...
    private void updateCurrentFeed(String currentCategory){
        Thread thread = new Thread() {
            @Override
            public void run() {
                com.zacharycalabrese.doughboy.simplenews.activity.Sync.News news = new com.zacharycalabrese.doughboy.simplenews.activity.Sync.News(context);
