...
public class News extends BaseAdapter{
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.News> articles;
    private LayoutInflater layoutInflater;
    private Context context;

    public News(Context context, List<
                com.zacharycalabrese.doughboy.simplenews.activity.Helper.News> articles) {
