...
import com.zacharycalabrese.doughboy.simplenews.activity.Data.News;
import com.zacharycalabrese.doughboy.simplenews.activity.Data.Weather;
...
public class Main extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            weatherViewHolder.floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context,
                            com.zacharycalabrese.doughboy.simplenews.activity.Activity.Weather.class);
    ...
    private void updateNewsViewHolder(RecyclerView.ViewHolder viewHolder) {
        ...
        List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.News> newsHelper =
        ...
        try {
            ...
            newsViewHolder.floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context,
                            com.zacharycalabrese.doughboy.simplenews.activity.Activity.News.class);
                    context.startActivity(intent);
                }
            });
        } catch (IndexOutOfBoundsException e) {
    ...
    private void setHeadline(TextView textView, String title, final String url) {
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,
                        com.zacharycalabrese.doughboy.simplenews.activity.Activity.Web.class);
