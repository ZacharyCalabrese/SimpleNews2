package com.zacharycalabrese.doughboy.simplenews.activity.Data;
...
public class Weather {
    ...
    public List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> getWeekData() {
        List<com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather> results =
                com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather
                        .listAll(com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather
                                .class);
        List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> helperWeatherList;
    ...
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather>
    initilizeHelperWeatherList(
            List<com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather> data) {

        List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> returningList;
        returningList = new ArrayList<>();

        for (com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather item : data) {
            com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather temp;
            temp = new com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather(item);
    ...
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> processTemperatures
            (List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> results) {

        for (com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather res : results) {
    ...
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> processConditionImages
            (List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> results) {
    ...
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> processConditions
            (List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> results) {
    ...
    private List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> processWind
            (List<com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather> results) {
    ...
    private void deleteOldData() {
        com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather
                .deleteAll(com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather.class);
    }
    ...
    private void writeToDatabase() {
        for (String[] workingDay : splitArrayOfJsonResults) {
            ...
            com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather weatherObject =
                    new com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather(
            ...
            com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather session;

            session = new com.zacharycalabrese.doughboy.simplenews.activity.Model.Weather(
                    weatherObject);
