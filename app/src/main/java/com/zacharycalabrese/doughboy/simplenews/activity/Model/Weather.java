package com.zacharycalabrese.doughboy.simplenews.activity.Model;
...
public class Weather extends SugarRecord<Weather> {
    ...
    public Weather(com.zacharycalabrese.doughboy.simplenews.activity.Helper.Weather weatherObject) {
